...
export class ReviewsController {
  ...
  @ApiOkResponse({
    description: 'Get Review of Property'
  })
  @ApiOperation({ summary: 'Get Review of Property' })
  async getReviewsByPropertyId(@Param('propertyId') propertyId: string) {
    return this.reviewsService.getReviewsByPropertyId(propertyId);
  }
  ...
  async getReviewsByReservationId(@Param('reservationId') reservationId: string): Promise<Review[]> {
