                            ...
                            <tbody>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:20px;font-weight:bold;line-height:24px;text-align:left;color:#212b35;">Wanderlust Booking Information</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">Bạn đã đặt phòng thành công</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">Đây là thông tin đặt phòng của bạn:</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">
                                    <ul>
                                      <li style="padding-bottom: 20px"><strong>Nơi lưu trú:</strong> ${property}.</li>
                                      <li style="padding-bottom: 20px"><strong>Thời gian check in:</strong> ${checkIn}.</li>
                                      <li style="padding-bottom: 20px"><strong>Thời gian check out:</strong> ${checkOut}.</li>
                                      <li style="padding-bottom: 20px"><strong>Số người:</strong> ${guestCount}.</li>
                                      <li style="padding-bottom: 20px"><strong>Tổng tiền:</strong> ${totalPrice}.</li>
                                    </ul>
                                  </div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:30px;word-break:break-word;">
                                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#637381;">Thông tin chi tiết về Wanderlust có thể tham khảo tại <a class="text-link" href="https://wanderlust-fe.vercel.app/" style="color: #5e6ebf;">https://wanderlust-fe.vercel.app/</a>. Nếu cần hỗ trợ thêm, xin vui lòng liên hệ Trung Tâm Hỗ Trợ Khách Hàng qua tổng đài 1900-0000 trò chuyện trực tuyến hoặc gửi email về <a href="mailto:wanderlustpbl06@gmail.com">wanderlustpbl06@gmail.com</a></div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
